...
export const basicType = async (
  ...
  const user_prompt = `Buatlah ${numOfQuestion} soal pilihan ganda dengan ${numOfOption} pilihan jawaban dan pembahasannya dengan ketentuan tambahan sebagai berikut: ${guidance}. Berikut materi yang digunakan:${inputMaterial}`;
