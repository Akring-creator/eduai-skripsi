...
const GameResult = ({ imageUrl, gamename, result }: GameResultProps) => {
  ...
  return (
    <div className="grid h-screen items-center justify-center  p-4 text-center ">
      ...
      <div className="mx-auto grid grid-cols-2 max-w-sm sm:grid-cols-2 md:gap-6 md:max-w-2xl lg:grid-cols-2 lg:max-w-4xl xl:grid-cols-2xl">
        <div className="flex items-center justify-center rounded-lg border border-gray-200 bg-blue-200 dark:bg-blue-900 shadow-sm md:order-last dark:border-gray-800 dark:bg-gray-950">
        ...
        <div className="flex items-center justify-center rounded-lg border border-gray-200 bg-red-200 dark:bg-red-900 shadow-sm md:order-last dark:border-gray-800 dark:bg-gray-950">
          <div className="grid gap-1 text-center">
