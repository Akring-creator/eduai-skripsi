    ...
    <Dialog>
      ...
      <DialogContent className="w-full">
        <DialogHeader>
          ...
          <DialogDescription>Perubahan tersimpan otomatis</DialogDescription>
        </DialogHeader>
        {!editing.question ? (
          <div onClick={enableQuestionInput} className="outline-none font-bold">
            {value.question}
          </div>
        ) : (
          <TextareaAutosize
        ...
        {initialData.options.map((option, index) => (
          <div key={index}>
            <OptionForm optionValue={option.option} optionId={option.id} />
          </div>
        ))}

        {!editing.answer ? (
          <div onClick={enableAnswerInput} className="outline-none font-medium">
            {value.answer}
          </div>
        ) : (
          <TextareaAutosize
