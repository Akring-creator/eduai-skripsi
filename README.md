...
1. **Alignment with HOTS criteria**  
2. **Question quality** (clarity, language accuracy, relevance to learning material)  
3. **Usability** (usefulness, ease of use, learnability, and user satisfaction)  

The study involved **32 geography teachers** from the MGMP community in Samarinda. Key results:  
- **Question Quality Index**: 87.25%  
- **Usability Score**: 86.08% (average ratings: 4.40/5 for usefulness, 4.29/5 for ease of use, 4.27/5 for ease of learning, and 4.38/5 for satisfaction)  
